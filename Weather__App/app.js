...
const API_KEY = '6ea368c6e1ffb15194c53099cb7cf4cc';
...
function updateHistory(history) {
    ...
    history.forEach(h => {
        ...
        temHistory.id = ''
        temHistory.getElementsByClassName('condition')[0].src = `${ICON_URL}${h.icon}.png`
        ...
        temHistory.getElementsByClassName('description')[0].innerHTML = h.description
